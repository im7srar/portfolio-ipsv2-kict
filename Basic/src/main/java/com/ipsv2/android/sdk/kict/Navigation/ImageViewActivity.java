package com.ipsv2.android.sdk.kict.Navigation;
...
import com.ipsv2.android.sdk.kict.SdkExample;
import com.ipsv2.android.sdk.kict.utils.ExampleUtils;
...
public class ImageViewActivity extends FragmentActivity {
    ...
    private IALocationListener mLocationListener = new IALocationListenerSupport() {
        ...
        public void onLocationChanged(IALocation location) {
            ...
            floor.setText(String.valueOf(location.getFloorLevel()));
    ...
    private IARegion.Listener mRegionListener = new IARegion.Listener() {
        ...
        public void onEnterRegion(IARegion region) {
            if (region.getType() == IARegion.TYPE_FLOOR_PLAN) {
                ...
                entered.setText(String.valueOf(region.getName()));
                TextView floorplan = (TextView)findViewById(R.id.floorplan);
                floorplan.setText(String.valueOf(region.getId()));
                ...
                TextView locationChanged = (TextView)findViewById(R.id.locationChanged);
                locationChanged.setText(String.valueOf(region.getId()));
